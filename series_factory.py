...
abc = SeriesFactory()
abc.create("/home/SoliareofAstora/space_memory/experiments/templates/checkpoint_single_v2_fat_linear_dqn/v0", "1m_long")
abc.multiply_parameters("steps",[1000000])
abc.multiply_parameters("memory_size", [5000])
abc.multiply_parameters("model_save_interval", [250000])
abc.multiply_parameters("depth",[5,10])
abc.multiply_parameters("width", [50,200])
abc.multiply_parameters("batch_size", [256])
abc.multiply_parameters("living_penalty", [0.05])
abc.multiply_parameters("eps_decay", [100000])
abc.multiply_parameters("gamma", [0.9])
abc.multiply_parameters("log_frequency", [100])
abc.multiply_parameters("eps_end",[0.05])
abc.multiply_parameters("target_update_frequency", [1000])
abc.multiply_parameters("lr", [0.0001, 0.01])
abc.print()
print(len(abc))
