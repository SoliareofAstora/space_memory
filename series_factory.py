...
abc = SeriesFactory()
abc.create("/home/SoliareofAstora/space_memory/experiments/templates/checkpoint_single_fat_linear_dqn/v0", "1m_long")
abc.multiply_parameters("steps",[1000000])
abc.multiply_parameters("memory_size", [100000,5000])
abc.multiply_parameters("model_save_interval", [250000])
abc.multiply_parameters("depth",[10,20])
abc.multiply_parameters("width", [100,200])
abc.multiply_parameters("batch_size", [128, 256])
abc.multiply_parameters("living_penalty", [0, 0.05,0.1])
abc.multiply_parameters("eps_decay", [1000000])
abc.multiply_parameters("gamma",[0.9,0.99])
abc.multiply_parameters("log_frequency", [100])
abc.multiply_parameters("eps_end",[0.1,0.01])
abc.multiply_parameters("target_update_frequency", [1000,500,5000])
abc.multiply_parameters("lr", [0.0001])
abc.print()
print(len(abc))
